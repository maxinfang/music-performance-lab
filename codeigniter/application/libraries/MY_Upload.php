...
/*		if ( ! $this->validate_upload_path())
		{
			...
			return FALSE;
		} DON'T NEED THIS AS WE ARE DOING THE UPLOAD ELSEWHERE*/
...
/*		if ( ! @copy($this->file_temp, $this->upload_path.$this->file_name))
	...
	/* Need to override this function from the Upload library, so that it checks
	 * the mime type correctly. 
	 * $file['tmp_path'] changed to $file['tmp_name']
	 */
