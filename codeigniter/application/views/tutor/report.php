...
if (isset($access_error)) { 
	...
	<?php echo form_open_multipart('/tutor/report/' . $placement_rid . '/update'); ?>  
		...
		<p>Please provide your comments for each. This information is extremely important in the process of marking students for the practical exams. It is imperative that you submit this report no later than the deadline stated on the <a href="tutor/">homepage</a>.</p>
    ...
    <p>
    <label for="repertoire_items">Please name the repertoire items the student has prepared in this period</label>
    <textarea name="repertoire_items" id="repertoire_items" class="textbox-large"><?php echo $form['repertoire_items']['value']; ?></textarea>
		</p>
    
    <div class="field-submit">
    <p><input type="submit" name="save" value="Save Progress" /> <input type="submit" name="submit" value="Submit" /></p>
    <p><a href="tutor">Cancel</a></p>
    </div>
